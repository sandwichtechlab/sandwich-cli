...
export interface EnvironmentDefinition {
  ...
  label: string;
  /** Main context file created at project root, e.g. CLAUDE.md, AGENTS.md */
  contextFileName: string;
  /** Where slash commands / prompts are stored */
  commandPath: string;
  /** Where skills are installed (undefined = env doesn't support skills) */
  skillsDir?: string;
  /** File extension for command files. Defaults to .md */
  commandExtension?: string;
  /** Gemini: commands are converted to .toml format */
  commandFormat?: "md" | "toml";
}

export type WorkflowType = "sdlc" | "adlc";
...
/**
 * Maps each bundled skill/command to the workflows it belongs to.
 * "both" means the skill is relevant in both SDLC and ADLC workflows.
 */
export const WORKFLOW_MAP: Record<string, WorkflowType | "both"> = {
  // Skills
  "brainstorming": "both",
  "capture-knowledge": "both",
  "debug": "both",
  "deployment": "both",
  "dev-lifecycle": "both",
  "memory": "both",
  "simplify-implementation": "both",
  "system-design": "both",
  ...
  "agent-observe": "adlc",
  "prompt-craft": "adlc",
  // Commands (same names as command files without .md)
  "plan": "both",
  "design": "both",
  "execute": "both",
  "recheck": "both",
  ...
  "capture": "both",
  "docs": "both",
  "update-planning": "both",
  "review-requirements": "both",
  "review-design": "both",
  "code-review": "both",
  // ADLC-only commands
  "craft": "adlc",
