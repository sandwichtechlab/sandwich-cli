---
name: brainstorming
description: Socratic questioning before implementation — ask clarifying questions about purpose, users, scope, and constraints before writing code. Mandatory for complex requests, new features, vague requirements, or architecture decisions. Includes structured progress reporting and error handling.
